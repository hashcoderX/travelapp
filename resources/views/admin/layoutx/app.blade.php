...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('admin_template/vendors/mdi/css/materialdesignicons.min.css') }}">  
  <link rel="stylesheet" href="{{ asset('admin_template/vendors/ti-icons/css/themify-icons.css') }}">  
  <link rel="stylesheet" href="{{ asset('admin_template/vendors/typicons/typicons.css') }}">  
  <link rel="stylesheet" href="{{ asset('admin_template/vendors/simple-line-icons/css/simple-line-icons.css') }}">  
  ...
  <link rel="stylesheet" href="{{ asset('admin_template/js/select.dataTables.min.css') }}">  
