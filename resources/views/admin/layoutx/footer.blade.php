 <!-- content-wrapper ends -->
  ...
  <!-- plugins:js -->
  <script src="{{ asset('admin_template/vendors/js/vendor.bundle.base.js') }}"></script>   
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <script src="{{ asset('admin_template/vendors/chart.js/Chart.min.js') }}"></script>  
  <script src="{{ asset('admin_template/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>   
  <script src="{{ asset('admin_template/vendors/progressbar.js/progressbar.min.js') }}"></script>   
  ...
  <script src="{{ asset('admin_template/js/jquery.cookie.js') }}" type="text/javascript"></script>  
